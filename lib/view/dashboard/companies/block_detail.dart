...
import 'false_companies_controller.dart';

showCompaniesBlockController controller = Get.find();
AcceptCompanyController controller2 = Get.find();

class BlockDetailes extends StatelessWidget {
  const BlockDetailes({super.key});
